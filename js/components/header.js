    ...
    <div class="container mx-auto px-4">
        <nav class="flex items-center justify-between">
            ...
            <a href="https://nctjinn.github.io/Archives/" class="hover:text-gray-300">
                <img src="/Archives/assets/images/logo.png" alt="Logo" class="w-6 h-6" style="filter: invert(1);">
            </a>
            ...
            <a href="https://github.com/NCTjinn" class="hover:text-gray-300">
                <img src="/Archives/assets/images/github.png" alt="GitHub" class="w-6 h-6" style="filter: invert(1);">
            </a>
        </nav>
    </div>
</header>
